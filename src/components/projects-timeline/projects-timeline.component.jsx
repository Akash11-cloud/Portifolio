...
// projects
import L_GetGitHubInfo from "../../assets/img/projects/unity.png";
import L_SmartBrain from "../../assets/img/projects/Travel.png";
import L_RoboFriends from "../../assets/img/skills/javascript.svg";
import L_ProductHuntClone from "../../assets/img/projects/python.png";
...
import L_POSTGRESQL from "../../assets/img/skills/python.svg";
    ...
    <div id="projects">
      ...
      <Timeline>
        <Events>
          ...
          <ImageEvent date="19/07/2020" className="text-center" text="Angrybird_clone" src={L_GetGitHubInfo} alt="Get GitHub Info">
            <div className="d-flex justify-content-between flex-column mt-1">
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> It is clone of Angry Birds
                        <hr />
                        ...
                        <ul>
                          <li>
                            <span className="p-2">
                              <Image src={C} alt="C#" rounded className="image-style m-1"></Image> C#
                            </span>
                          {/* </li>
                          <li>
                            <span className="p-2">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton href="https://github.com/Akash11-cloud/Angrybird_clone" target="_blank">
                  SOURCE CODE
                </UrlButton>
          ...
          {/* Project: Smart Brain */}
          <ImageEvent date="21/01/2020" className="text-center" text="Time to Travel" src={L_SmartBrain} alt="Smart Brain Face Detect">
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> To build a travel application that contains a simple form which obtains information on user's upcoming trip - destination and departure date. With the help of external APIs - Geonames, Dark Sky and Pixabay, the app then displays weather and an image of the location on that given date
                        <hr />
                        {/* <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                        ...
                        <ul>
                          ...
                          <li>
                          <span className="p-2">
                              <Image src={L_RoboFriends} alt="CSS 3" rounded className="image-style m-1"></Image> Javascript
                            </span>
                          </li>
                          <li>
                            <span className="p-2">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton href="https://github.com/Akash11-cloud/TRAVEL-APP" target="_blank">
                  SOURCE CODE
                </UrlButton>
              </div>
            </div>
          ...
          <ImageEvent date="14/01/2020" className="text-center" text="PYTHON GAME" src={L_ProductHuntClone} alt="Robo Friends">
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong>A simple pyhton GAME
                        {/* <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                        ...
                        <ul>
                          ...
                          <li>
                            <span className="p-2">
                              <Image src={L_POSTGRESQL} alt="PostgreSQL" rounded className="image-style1 m-1"></Image> Python
                            </span>
                          </li> 
                        </ul>
                      </Card.Body>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                ...
                <UrlButton href="https://github.com/Akash11-cloud/UDACITY-PYTHON-GAME-" target="_blank">
                  SOURCE CODE
                </UrlButton>
              </div>
            </div>
